...
```javascript
// Basic Information
valentineName: "Ruby"                    // Your Valentine's name
...
loveMessages: {
    ...
    high: "Will You Be My Gwen! 🚀💝",              // Shows above 1000%
    normal: "Anddddd SWING TO VALNTINE WITH ME! 🥰"                           // Shows above 100%
}

// Final Celebration
celebration: {
    title: "Yay! I'm the luckiest person...",     // Celebration title
    message: "gift coming SOON, I LOVE YOU",          // Celebration message
...
music: {
    ...
    musicUrl: ["YOUR_CLOUDINARY_URL_HERE"](https://res.cloudinary.com/dd7ene4vx/video/upload/v1770859113/Usher_-_Hey_Daddy_Daddys_Home_Lyrics_lwgker.mp3), // Paste your music URL here
